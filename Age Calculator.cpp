...
int main()
{
    ...
    /* enter date of birth */
    printf("This code was written by \"The Assassin\"\n");
    printf("For more visit:-\n");
    printf("                Instagram:- https://www.instagram.com/cyberthunderr/ \n");
    printf("                Facebook:- https://www.facebook.com/cyberthunderr/ \n");
